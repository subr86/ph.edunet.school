...
if (isloggedin()) {
    ...
    echo $OUTPUT->render_from_template('theme_go4moreschool/frontpage', $templatecontext);
} else {
    ...
    echo $OUTPUT->render_from_template('theme_go4moreschool/frontpage_guest', $templatecontext);
}
